...
import CaseTab from "@/components/profile/tabs/cases"
import c_type_divider from "@/components/profile/c_type_divider";
import AccuserTab from "@/components/profile/tabs/accuser";
import AddressCard from "@/components/profile/c_address_card.vue";
import InvestigationReportTab from "@/components/profile/tabs/iReport.vue";
...
export default {
  ...
  components: {
    ...
    'tb-biograph': CaseTab,
    'tb-services': AccuserTab,
    'v-address-card': AddressCard,
    'tb-insurance': InvestigationReportTab
  },
  data() {
    return {
      dialog: false,
